...
ifeq ($(DEB_BUILD),0)
	...
	install -m 644 ./icons/adi-colorimeter16.png \
		$(DESTDIR)/usr/share/icons/hicolor/16x16/apps/adi-colorimeter.png
	install -m 644 ./icons/adi-colorimeter32.png \
		$(DESTDIR)/usr/share/icons/hicolor/32x32/apps/adi-colorimeter.png
	install -m 644 ./icons/adi-colorimeter64.png \
		$(DESTDIR)/usr/share/icons/hicolor/64x64/apps/adi-colorimeter.png
endif
...
ifeq ($(DEB_BUILD),0)
	...
	rm -f $(DESTDIR)/usr/share/applications/adi-colorimeter.desktop
	rm -f $(DESTDIR)/usr/share/icons/hicolor/16x16/apps/adi-colorimeter.png
	rm -f $(DESTDIR)/usr/share/icons/hicolor/32x32/apps/adi-colorimeter.png
	rm -f $(DESTDIR)/usr/share/icons/hicolor/64x64/apps/adi-colorimeter.png
endif
